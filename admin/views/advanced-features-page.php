...
<?php endif; ?>
				...
				<div class="py-8 md:py-12">
					...
					<div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4 mb-8">
						...
						<div class="flex justify-center">
							...
							<?php else : ?>
								<div class="inline-flex items-center gap-3 px-8 py-4 bg-red-400/25 backdrop-blur-xl rounded-full border border-red-300/90 shadow-2xl ring-1 ring-red-300/30" style="box-shadow: 0 20px 52px #ef4444ff;" title="Not connected to Mypowerly. Connect to unlock advanced features." aria-label="Not connected to Mypowerly. Connect to unlock advanced features.">
					...
					<div class="text-center max-w-4xl mx-auto mp-hero-inner">
						...
						<p class="text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
							...
							<?php else : ?>
								Connect your site to Mypowerly to unlock advanced features like data synchronization, affiliate tracking, and more.
							<?php endif; ?>
						</p>
	...
	<div class="max-w-screen-2xl mx-auto px-3 sm:px-4 lg:px-6 pb-12">
		...
		<?php if ( ! $mp_connected ) : ?>
			<!-- Not Connected Alert -->
			<div class="mp-card mb-8 border-l-4 border-amber-500" id="af-not-connected-alert">
				<div class="p-6">
					<div class="flex items-start gap-4">
		...
		<!-- Dashboard Content - Always visible, disabled when not connected -->
		<div class="mb-10 <?php echo ( ! $mp_connected ) ? 'af-disabled-section' : ''; ?>" id="data-sync-dashboard-section" data-connected="<?php echo $mp_connected ? '1' : '0'; ?>">
			<?php if ( ! $mp_connected ) : ?>
				<fieldset disabled>
			<?php endif; ?>
			<div class="text-center mb-10">
				<h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Data Synchronization Dashboard</h2>

					<div class="flex items-center justify-center gap-2 text-gray-600 text-lg max-w-3xl mx-auto">
						<span>Sync your WordPress data securely with Mypowerly (API Provider) to unlock benefits, helps in chasing reminder systems via multiple channels</span>
						<span class="mp-help-tooltip">
							<button type="button" class="mp-help-icon" aria-label="External service disclosure">
								<i class="fas fa-info-circle"></i>
							</button>
							<div class="mp-help-bubble" style="right: auto; left: 50%; transform: translateX(-50%); bottom: 44px;">
								<div class="mp-help-title">External service disclosure</div>
				...
				<div class="mp-card mb-6" style="border-left: 4px solid var(--mp-primary);">
					<div class="p-6">
						<div class="flex items-start justify-between gap-6">
							<div class="flex items-start gap-4">
								<div class="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center flex-shrink-0">
									<i class="fas fa-sync text-2xl text-blue-600"></i>
								</div>
								<div>
									<h4 class="text-xl font-bold text-gray-800 mb-1">Automatic Sync</h4>
									<p class="text-gray-600 text-sm">When enabled, data will automatically sync and send to webhook when changes occur. Manual sync buttons will always work regardless of this setting.</p>
								</div>
							</div>
							<div class="flex items-center gap-3">
								<label class="w91099ch-toggle" for="w91099ch-enable-auto-sync">
									<input type="checkbox" id="w91099ch-enable-auto-sync" <?php checked( get_option( 'w91099ch_enable_auto_sync', 0 ) ); ?>>
									<span class="w91099ch-toggle-track" aria-hidden="true">
										<span class="w91099ch-toggle-thumb" aria-hidden="true"></span>
									</span>
									<span class="w91099ch-toggle-text">Auto Sync</span>
								</label>
								<span id="w91099ch-auto-sync-state" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold" data-enabled="<?php echo (int) (bool) get_option( 'w91099ch_enable_auto_sync', 0 ); ?>">
									<?php echo get_option( 'w91099ch_enable_auto_sync', 0 ) ? 'ON' : 'OFF'; ?>
								</span>
							</div>
						</div>
					</div>
				...
				<!-- Sync All Section - FIXED -->
				<div class="mp-card mp-sync-all mb-8">
					<div class="mp-sync-all-header">
						<div class="flex items-start gap-12">
							<div class="flex items-center gap-12">
								<div class="w-12 h-12 rounded-xl bg-white/15 flex items-center justify-center" style="box-shadow: 0 14px 30px rgba(0,0,0,0.18); border: 1px solid rgba(255,255,255,0.20);">
									<i class="fas fa-bolt text-xl icon-tooltip" style="color: rgba(255,255,255,0.95);" data-tooltip="Sync all 9 cards data in one payload"></i>
								</div>
								<div>
									<h3 class="mp-sync-all-title">Sync All Data at Once</h3>
								</div>
							</div>
						</div>
					<div class="mp-sync-all-badges">
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #a78bfa;"></span>Plugins</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #34d399;"></span>Affiliates/Vendors</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #fbbf24;"></span>Team/Users</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #60a5fa;"></span>Forms</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #f472b6;"></span>Memberships</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #f97316;"></span>Contractors</span>
						<span class="mp-sync-all-badge"><span class="mp-sync-all-badge-dot" style="background: #10b981;"></span>Freelancers</span>
					...
					<div class="mp-sync-all-body">
						<div class="mp-sync-all-consent">
						...
						<div class="mp-sync-all-actions">
							<button type="button" id="sync-all-data" class="mp-btn-primary flex items-center gap-3 opacity-60 cursor-not-allowed" disabled>
								<i class="fas fa-rotate"></i>
								Sync All Data Now
							</button>
							<div class="mp-sync-all-actions-note">This does not include W9 form data.</div>
						</div>
					</div>

					<!-- Progress Section -->
					<div class="hidden mp-sync-all-progress" id="sync-all-progress-section">
						<div class="mb-4">
							<div class="flex justify-between items-center mb-4">
								<span class="font-medium text-gray-700">Sync Progress</span>
								<span id="sync-all-progress-text" class="font-bold text-blue-600">0%</span>
							</div>
							<div class="mp-progress-bar">
								<div id="sync-all-progress-fill" class="mp-progress-fill" style="width: 0%"></div>
							</div>
						</div>

						<div class="mb-6">
							<div class="mb-3">
								<div id="current-sync-all-step" class="font-medium text-gray-700">Initializing sync...</div>
							</div>
							<div class="grid grid-cols-1 md:grid-cols-3 gap-3">
								<div class="sync-step p-3 bg-gray-50 rounded-xl" data-step="plugin">
									<div class="flex items-center gap-3 mb-2">
										<div class="w-9 h-9 rounded-lg bg-purple-100 flex items-center justify-center">
											<i class="fas fa-plug text-purple-600 icon-tooltip" data-tooltip="Detect and sync All plugins"></i>
										</div>
										<div>
											<div class="font-semibold text-gray-800">Plugins</div>
											<div class="step-status step-pending">Pending</div>
										</div>
									</div>
									<div class="text-xs text-gray-600">Detected All plugins</div>
								</div>

								<div class="sync-step p-3 bg-gray-50 rounded-xl" data-step="affiliate">
									<div class="flex items-center gap-3 mb-2">
										<div class="w-9 h-9 rounded-lg bg-green-100 flex items-center justify-center">
											<i class="fas fa-handshake text-green-600 icon-tooltip" data-tooltip="Sync all affiliates and vendors data"></i>
										</div>
										<div>
											<div class="font-semibold text-gray-800">Affiliates/Vendors</div>
											<div class="step-status step-pending">Pending</div>
										</div>
									</div>
									<div class="text-xs text-gray-600">All affiliates/vendors data</div>
								</div>

								<div class="sync-step p-3 bg-gray-50 rounded-xl" data-step="team">
									<div class="flex items-center gap-3 mb-2">
										<div class="w-9 h-9 rounded-lg bg-orange-100 flex items-center justify-center">
											<i class="fas fa-users text-orange-600 icon-tooltip" data-tooltip="Sync team members and user accounts"></i>
										</div>
										<div>
											<div class="font-semibold text-gray-800">Team/Users</div>
											<div class="step-status step-pending">Pending</div>
										</div>
									</div>
									<div class="text-xs text-gray-600">Team members and user accounts</div>
								</div>

								<div class="sync-step p-3 bg-gray-50 rounded-xl" data-step="forms">
									<div class="flex items-center justify-between mb-2">
										<div class="flex items-center gap-3">
											<div class="w-9 h-9 rounded-lg bg-blue-100 flex items-center justify-center">
												<i class="fas fa-wpforms text-blue-600 icon-tooltip" data-tooltip="Sync all form plugin data"></i>
											</div>
											<div>
												<div class="font-semibold text-gray-800">Forms</div>
												<div class="step-status step-pending">Pending</div>
											</div>
										</div>
										<?php
...
$wp_detector         = new w91099ch_Wallet_Payout_Plugin_Detector();
						...
						<div class="flex items-start justify-between gap-3 mb-3">
							<div class="flex items-start gap-3">
								...
								<div>
									...
									<p class="text-sm text-gray-600">Detect and sync ecommerce platform data</p>
								</div>
							</div>
							...
							<div class="mp-help-tooltip">
								...
								<div class="mp-help-bubble">
									<div class="mp-help-title">What this card does</div>
									<div class="mp-help-line"><strong>Detection:</strong> WooCommerce, Dokan, WCFM, Stripe, PayPal.</div>
									<div class="mp-help-line"><strong>Function:</strong> Identifies which ecommerce platforms are active and ready for sync.</div>
									<hr style="margin: 10px 0; border: none; border-top: 1px solid #e5e7eb;">
									<div class="mp-help-title">Data that will be sent</div>
									<div class="mp-help-line"><strong>Platform Info:</strong> Name, version, active status.</div>
								</div>
							</div>
						</div>
						...
						<div class="mb-4" style="flex: 1;">
							...
							<div class="bg-gray-50 rounded-xl p-4">
								<?php if ( ! empty( $detected_ecom ) ) : ?>
									<div class="space-y-3">
										<?php foreach ( $detected_ecom as $ecom ) : ?>
											<div class="flex items-center justify-between p-2 bg-white rounded-lg border border-gray-200">
												<div class="flex items-center gap-2">
													<i class="fas fa-check-circle text-green-500"></i>
													<span class="text-sm font-medium text-gray-800"><?php echo esc_html( $ecom['name'] ); ?></span>
												</div>
												<span class="text-xs px-2 py-0.5 rounded-full <?php echo $ecom['active'] ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'; ?>">
													<?php echo $ecom['active'] ? 'Active' : 'Inactive'; ?>
												</span>
											</div>
										<?php endforeach; ?>
									</div>
								<?php else : ?>
									<div class="text-center py-4 text-gray-500">
										...
										<p class="text-sm">No ecommerce plugins detected</p>
									</div>
								<?php endif; ?>
							</div>
						</div>
		...
		<?php if ( ! empty( $enc_param ) ) : ?>
			<!-- Connection Progress - Shows when processing connection -->
...
jQuery(document).ready(function($) {
	...
	(function initMypowerlyOptIn() {
		const storageKey = 'mypowerly_opt_in';
		const $dataSyncSection = $('#data-sync-dashboard-section');
		const getConnectedFromDom = function() {
			const attr = String(($dataSyncSection && $dataSyncSection.length) ? ($dataSyncSection.attr('data-connected') || '') : '');
		...
		const disableAdvancedControls = function() {
			...
			$dataSyncSection.find('input, select, textarea, button').each(function() {
				const $el = $(this);
		...
		const getInitialOptIn = function() {
		...
		const updateSaveToggleVisibility = function(show) {
			const $toggle = $('#mypowerly-save-toggle');
			if ($toggle.length) {
				$toggle.prop('checked', !!show);
			}
		};

		const initialOptIn = getInitialOptIn();

		if ($('#mypowerly-consent').length) {
			$('#mypowerly-consent').prop('checked', initialOptIn);
		} else {
			updateSaveToggleVisibility(initialOptIn);
		}

		if (!isConnected) {
			updateSaveToggleVisibility(false);
			disableAdvancedControls();
			// Hard-block any events that might still toggle state (e.g., labels / delegated handlers)
			$(document).off('click.w91099chDisable change.w91099chDisable keydown.w91099chDisable');
			$(document).on('click.w91099chDisable change.w91099chDisable keydown.w91099chDisable', '#data-sync-dashboard-section input, #data-sync-dashboard-section select, #data-sync-dashboard-section textarea, #data-sync-dashboard-section button, #data-sync-dashboard-section a', function(e) {
				e.preventDefault();
		...
		const handleOptInChange = function(checked) {
			...
			if (isConnected) {
				updateSaveToggleVisibility(checked);
			}
		};
		...
		$('#mypowerly-save-toggle').off('change.mypowerly').on('change.mypowerly', function() {
			handleOptInChange(!!this.checked);
		});

		$('#connect-mypowerly-cta').off('click.mypowerly');
	})();
