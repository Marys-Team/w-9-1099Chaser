<?php
/**
 * Freelancer / Contractor Management Plugin AJAX Handlers
 */
...
add_action( 'wp_ajax_w91099ch_get_freelancer_contractor_entries_preview', 'w91099ch_get_freelancer_contractor_entries_preview' );
function w91099ch_get_freelancer_contractor_entries_preview() {
	try {
		...
		error_log( 'W9-1099-Chaser Freelancer AJAX Error: ' . $e->getMessage() );
		wp_send_json_error( array( 'message' => 'Error loading freelancer data: ' . $e->getMessage() ) );
	}
}
